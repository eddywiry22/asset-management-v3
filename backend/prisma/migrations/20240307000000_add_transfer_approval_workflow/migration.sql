-- Stage 7: Full 7-state approval workflow for StockTransferRequest
-- Replaces DRAFT→APPROVED→REJECTED→FINALIZED with the correct state machine.

-- Extend enum: add all required states
