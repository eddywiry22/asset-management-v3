...
import { createUserSchema, updateUserSchema, resetPasswordSchema } from './admin-users.validator';
...
router.patch('/:id/reset-password', validateBody(resetPasswordSchema), (req, res, next) =>
